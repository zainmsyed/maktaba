...
## Checklist
- [ ] Build the library route and top-level layout
- [ ] Add the upload interaction and optimistic/loading states
- [ ] Render text-first document cards without thumbnails
- [ ] Add sorting controls for the PRD sort modes
- [ ] Show processing state on each document card
